...
map('n', '<c-s-k>', ':lua require("metals").hover_worksheet()<cr>', nrs)
map('n', '<c-e>', '6<c-e>', nor)
map('n', '<c-y>', '6<c-y>', nor)
...
map('n', '<leader>fF', ':Telescope resume<cr>', nrs)
...
map('n', '<leader>xx', ':Trouble diagnostics toggle focus=false filter.buf=0<cr>', nrs)
